...
* LICENSE
*
* This file was sourced from a stack overflow
* question by user inControl
* answered by user Noctis Skytower
* The link to the orginal question is here:
* http://stackoverflow.com/questions/11906925/python-simulate-keydown
*
* Accordingly, the content of this file is licensed under
* the Creative Commons Attribution Share Alike, which can be referenced
* here:
* http://creativecommons.org/licenses/by-sa/3.0/
*
* Per the license, the modifications need to be noted.
* The original is stored in keyboarder.py.orig
* Running a diff will display the exact changes, however
* the major changes are noted below via in-line comments.
*
*******************************************************************************
"""
